...
plot(pam(spp.Hg.newcode$D.matrix,2,diss=TRUE),, main="HUBERT's GAMMA used for cluster assignment")
...
#Make silhouette plot
plot(pam(spp.Hg.newcode$D.matrix,2,diss=TRUE), main="SILHOUETTE used for cluster assignment")
abline(v=c(0.25,0.5,0.75),col="red",lwd=c(1,2,3))
